...
public class PhoneEditText extends AppCompatEditText implements View.OnFocusChangeListener {
    ...
    public PhoneEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.baselib_PhoneEditText);
        String dividerString = typedArray.getString(R.styleable.baselib_PhoneEditText_baselib_dividerString);
...
//        	throw new NullPointerException("You can add drawableRight attribute in XML");
            mClearDrawable = getResources().getDrawable(R.drawable.baselib_delete_selector);
        }
