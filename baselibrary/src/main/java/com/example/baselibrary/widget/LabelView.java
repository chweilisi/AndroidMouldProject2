...
public class LabelView extends View {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.baselib_LabelView);
        mFqSize = ta.getInt(R.styleable.baselib_LabelView_baselib_lv_fill_size, 0);
        mTextContent = ta.getString(R.styleable.baselib_LabelView_baselib_lv_text);
        mTextColor = ta.getColor(R.styleable.baselib_LabelView_baselib_lv_text_color, Color.parseColor("#ffffff"));
        mTextSize = ta.getDimension(R.styleable.baselib_LabelView_baselib_lv_text_size, sp2px(11));
        mTextBold = ta.getBoolean(R.styleable.baselib_LabelView_baselib_lv_text_bold, true);
        mTextAllCaps = ta.getBoolean(R.styleable.baselib_LabelView_baselib_lv_text_all_caps, true);
        mFillTriangle = ta.getBoolean(R.styleable.baselib_LabelView_baselib_lv_fill_triangle, false);
        mBackgroundColor = ta.getColor(R.styleable.baselib_LabelView_baselib_lv_background_color, Color.parseColor("#FF4081"));
        mMinSize = ta.getDimension(R.styleable.baselib_LabelView_baselib_lv_min_size, mFillTriangle ? dp2px(35) : dp2px(50));
        mPadding = ta.getDimension(R.styleable.baselib_LabelView_baselib_lv_padding, dp2px(3.5f));
        mGravity = ta.getInt(R.styleable.baselib_LabelView_baselib_lv_gravity, Gravity.TOP | Gravity.LEFT);
        ta.recycle();
    }
