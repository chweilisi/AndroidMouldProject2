...
public class CBAlignTextView extends AppCompatTextView {
    ...
    public CBAlignTextView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.baselib_CBAlignTextView);

        isConvert = ta.getBoolean(R.styleable.baselib_CBAlignTextView_baselib_punctuationConvert, false);
