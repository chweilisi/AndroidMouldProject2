...
package com.example.baselibrary.widget.expandabletextview;
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        mAnimationDuration = typedArray.getInt(R.styleable.baselib_ExpandableTextView_baselib_animDuration, DEFAULT_ANIM_DURATION);
        mExpandDrawable = typedArray.getDrawable(R.styleable.baselib_ExpandableTextView_baselib_expandDrawable);
        mCollapseDrawable = typedArray.getDrawable(R.styleable.baselib_ExpandableTextView_baselib_collapseDrawable);

        textCollapse = typedArray.getString(R.styleable.baselib_ExpandableTextView_baselib_textCollapse);
        ...
        if (TextUtils.isEmpty(textCollapse)) {
            textCollapse = getContext().getString(R.string.baselib_collapse);
        }
    ...
    private void findViews() {
        ...
        inflater.inflate(R.layout.baselib_item_expand_collapse, this);
