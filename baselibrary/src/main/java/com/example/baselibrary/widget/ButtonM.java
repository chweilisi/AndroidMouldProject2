...
public class ButtonM extends AppCompatButton {
    ...
    private String textColors = "#ffff00";//文字颜色，String类型
    private int textColori = 0;//文字颜色，int类型
    private String textColorSeleteds = "#ff8800";//按下后的文字颜色，String类型
