...
import com.example.baselibrary.util.DimensUtils;
...
public class ExpandableLinearLayout extends LinearLayout implements View.OnClickListener {
    ...
    public ExpandableLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.baselib_ExpandableLinearLayout);
        defaultItemCount = ta.getInt(R.styleable.baselib_ExpandableLinearLayout_baselib_defaultItemCount, 2);
        expandText = ta.getString(R.styleable.baselib_ExpandableLinearLayout_baselib_expandText);
        hideText = ta.getString(R.styleable.baselib_ExpandableLinearLayout_baselib_hideText);
        fontSize = ta.getDimension(R.styleable.baselib_ExpandableLinearLayout_baselib_tipTextSize, DimensUtils.sp2px(context, 14));
        textColor = ta.getColor(R.styleable.baselib_ExpandableLinearLayout_baselib_tipTextColor, Color.parseColor("#666666"));
        arrowResId = ta.getResourceId(R.styleable.baselib_ExpandableLinearLayout_baselib_arrowDownImg, R.mipmap.baselib_arrow_down);
        useDefaultBottom = ta.getBoolean(R.styleable.baselib_ExpandableLinearLayout_baselib_useDefaultBottom, true);
        ta.recycle();
    ...
    private void findViews() {
        bottomView = View.inflate(getContext(), R.layout.baselib_item_ell_bottom, null);
