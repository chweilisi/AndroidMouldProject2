...
public class AlignTextView extends AppCompatTextView {
    ...
    public AlignTextView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.baselib_AlignTextView);

        int alignStyle = ta.getInt(R.styleable.baselib_AlignTextView_baselib_align, 0);
        switch (alignStyle) {
            case 1:
