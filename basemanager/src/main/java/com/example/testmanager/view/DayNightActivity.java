...
import com.example.testmanager.adapter.SimpleAuthorAdapter;
import com.example.testmanager.helper.DayNightHelper;
import com.example.testmanager.type.DayNight;
...
public class DayNightActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // initData和initTheme需要放在setContentView之前
        initData();
        initTheme();
        setContentView(R.layout.testlibrary_activity_daynight);
        initView();
    }
