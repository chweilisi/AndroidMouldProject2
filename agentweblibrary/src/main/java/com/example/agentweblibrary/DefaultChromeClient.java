package com.example.agentweblibrary;
...
//            e.printStackTrace();
    ...
    public void onHideCustomView() {
        if (AgentWebUtils.isOverriedMethod(mWebChromeClient, "onHideCustomView", ChromePath + ".onHideCustomView", View.class, WebChromeClient.CustomViewCallback.class)) {
